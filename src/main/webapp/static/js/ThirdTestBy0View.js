...
function showDateArray(dataArray) {
    for(var i=0 ;i<dataArray.length;i++){
        var str = "<tr id=" + dataArray[i].thirdid + ">";
            str += "<td align='center'><a href='showModView?id="+dataArray[i].thirdid+"'>修改</a>"+"<a href='#' onclick='del("+dataArray[i].thirdid+")'>删除</a>"+"</td>";
                    ...
                    str += "<td style='display: none;'>" + dataArray[i].thirdid + "</td>";
            str += "</tr>";
