        ...
        render: function (container) {
            ...
            if (container) {
                ...
                container.appendChild(domUtils.createElement(document, 'iframe', {
                    ...
                    height: "100%",
                    frameborder: "0",
                    src: 'javascript:void(function(){document.open();' + (options.customDomain && document.domain != location.hostname ?  'document.beforedomain="' + document.domain + '";' : '') +
...
//                                    range = sel.getRange();
//                                if (range) {
//                                    var beforecommon = range.getCommonAncestor();
//                                    if (beforecommon && me.serialize) {
//                                        var f = me.serialize,
//                                            node =
//                                                f.filter(
//                                                    f.transformInput(
//                                                        f.parseHTML(
//                                                            f.word(beforecommon.innerHTML)
//                                                        )
//                                                    )
//                                                );
//                                        beforecommon.innerHTML = f.toHTML(node);
//                                    }
//                                }
//                            }
//                            innerDrag = 0;
